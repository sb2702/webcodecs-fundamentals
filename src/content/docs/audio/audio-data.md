...
![](/assets/audio/audio-data/AudioData.png)
...
![](/assets/audio/audio-data/waveform.png)
...
|---|---|
| ![Left waveform](/assets/audio/audio-data/bbb-left.png) | ![Right waveform](/assets/audio/audio-data/bbb-right.png) |
| <audio controls><source src="/assets/audio/audio-data/bbb-left-2.mp3" type="audio/mpeg"></audio> | <audio controls><source src="/assets/audio/audio-data/bbb-right-2.mp3" type="audio/mpeg"></audio> |
