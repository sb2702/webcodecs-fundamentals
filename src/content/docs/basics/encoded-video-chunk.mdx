...
The `EncodedVideoChunk` class, the other main type in WebCodecs, repesents the compressed (or "encoded") version of a single `VideoFrame` ([mostly](#sequence-matters)).
...
<video width="640" height="480" loop muted autoplay>
  <source src="/src/assets/content/basics/chunks/raw-frames-animation.webm" type="video/webm" />
...
<video width="640" height="480" loop muted autoplay>
  <source src="/src/assets/content/basics/chunks/encoded-chunks-animation.webm" type="video/webm" />
  Your browser does not support the video tag.
</video>
...
<img src="/src/assets/content/basics/codecs/bouncing-ball.gif" alt="drawing"  style="margin:auto;" width="300"/>
...
![](/src/assets/content/basics/chunks/frame-diff-1.png)
...
![](/src/assets/content/basics/chunks/frame-diff-2.png)
...
![](/src/assets/content/basics/chunks/frame-diff-3.png)
...
![](/src/assets/content/basics/chunks/frame-diff-4.png)

This is exacly what real-world codecs do, with delta frames typically being 2x to 10x smaller than key frames [[do the study, make the citation](./tbd))].
...
const chunks = <EncodedVideoChunk[]> await demux(<File> file);
