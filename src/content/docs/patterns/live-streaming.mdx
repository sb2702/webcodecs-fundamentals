...
All the examples thus far have been without authentication. There is an [authentication mechanism](https://github.com/moq-dev/moq/tree/main/rs/moq-token) for Media over Quic but it is still not well documented. 
