...
Web Sockets enables you create a persistent connection with a server, and send enables you to send a stream of multiple messages of data. Here you could come up with your own binary encoding scheme to fit metadata and chunk data together into a single binary buffer and send that.
