...
Media over Quic greatly simplifies the networking aspect, while also being performant and providing low-level control, making it ideal for this use case, so that's what we'll use in the rest of our examples. 

You're of course free to use any data transfer mechanism you see fit, that is one of the benefits of WebCodecs.

You can find out more about Media over Quic [here](../../projects/moq).
